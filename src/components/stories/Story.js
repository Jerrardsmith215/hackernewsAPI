  ...
  return (
    <>
      ...
      <Paper sx={{ p: 2 }} elevation={6}>
        <Typography variant="h5" component="h2"><RouterLink state={{storyId: storyId, title: title, author: author, written: written, text: text, link: link ,}} to={`/${storyId}`}>{title}</RouterLink></Typography>
